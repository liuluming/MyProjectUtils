...
public class TelListsInfo implements Serializable {
    ...
    public String getTelAdress() {
        return telAdress;
    }

    public void setTelAdress(String telAdress) {
        this.telAdress = telAdress;
    }

    @Override
    public String toString() {
        return "TelListsInfo [id=" + id + ", gravator=" + gravator + ", name="
                + name + ", dialFlag=" + dialFlag + ", telMode=" + telMode
                + ", time=" + time + ", telephone=" + telephone
                + ", loginPhone=" + loginPhone + ", telAdress=" + telAdress
                + ", isTop=" + isTop + "]";
    }
