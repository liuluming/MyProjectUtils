// @author Bhavya Mehta
package com.my51c.see51.app.voipphone;
...
import com.my51c.see51.app.VoipActivity;
...
public class PinnedHeaderAdapter extends BaseAdapter implements OnScrollListener, IPinnedHeader, Filterable {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(mContext, AcContactsDetails.class);
                intent.putExtra("infodate", mListItems.get(position).toString());
    ...
    public Filter getFilter() {
        return ((VoipActivity) mContext).new ListFilter();
    }
